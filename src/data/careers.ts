...
export const JOBS: Job[] = [
  ...
  },
  {
    ...
    description: "Drive business growth by identifying new opportunities, building client relationships, and closing deals in the IT services space.",
    type: "Full Time",
    location: "Noida (Work From Office)",
    category: "Operations",
    ...
    lifeAt: "At Sanjivani Edge, people don’t just work on projects, they build products, relationships and careers. Choosing Sanjivani Edge means choosing a place where your work actually matters. Here, you are trusted with real responsibility, encouraged to grow faster, and supported by teams that believe in building solutions. You will work with modern technologies, global clients and people who value clarity, ownership and smart execution. If you are someone who wants to build, learn and see real impact from your work - JOIN US!",
    responsibilities: [
      "Identifying and generating new business opportunities through LinkedIn, cold calling, email campaigns and networking",
      "Building and maintaining strong relationships with potential clients in international markets (US, UK, Europe, APAC)",
      "Understanding client requirements and pitching relevant IT services/solutions",
      "Scheduling and coordinating meetings between clients and technical teams",
      "Preparing proposals, presentations and contracts to close deals",
      "Tracking sales targets and maintaining a robust sales pipeline using CRM tools",
      "Collaborating with the marketing and technical teams to align service offerings with market needs"
    ],
    requirements: [
      "1–4 years of experience in Business Development or Inside Sales (IT services preferred)",
      "Strong understanding of the IT/Software services market",
      "Proven track record of lead generation and meeting sales targets",
      "Excellent verbal and written communication skills",
      "Ability to negotiate and build long-term client relationships",
      "Self-motivated, result-oriented and able to work in a fast-paced environment"
    ],
    perks: [
      "Direct impact on company revenue and growth",
      "High-performance sales culture with attractive incentives",
      "Exposure to global markets and international clients",
      "Long-term career growth in Sales and Business Development",
      "Collaborative and people-first work environment"
    ]
  },
  {
    ...
    description: "Lead digital marketing initiatives to enhance brand visibility and generate high-quality leads using SEO, SEM, and social media strategies.",
    type: "Full Time",
    location: "Noida (Work From Office)",
    category: "Operations",
    experience: "3 to 5 Years",
    ...
    lifeAt: "At Sanjivani Edge, people don’t just work on projects, they build products, relationships and careers. Choosing Sanjivani Edge means choosing a place where your work actually matters. Here, you are trusted with real responsibility, encouraged to grow faster, and supported by teams that believe in building solutions. You will work with modern technologies, global clients and people who value clarity, ownership and smart execution. If you are someone who wants to build, learn and see real impact from your work - JOIN US!",
    responsibilities: [
      "Planning and executing digital marketing campaigns across LinkedIn, Google Ads, Facebook and Twitter",
      "Managing and optimizing SEO/SEM strategies to improve website ranking and traffic",
      "Creating engaging content for social media, blogs, newsletters and case studies",
      "Analyzing campaign performance using Google Analytics and other tools to improve ROI",
      "Managing email marketing campaigns and lead nurturing workflows",
      "Collaborating with design and web teams to create high-converting landing pages",
      "Staying updated with the latest digital marketing trends and tools"
    ],
    requirements: [
      "3–5 years of experience in Digital Marketing (B2B IT services preferred)",
      "Strong hands-on experience with SEO, SEM, Google Analytics and LinkedIn Ads",
      "Proven ability to generate leads and improve brand presence",
      "Good content writing and copywriting skills",
      "Analytical mindset with a data-driven approach to decision making",
      "Certifications in Google Ads or HubSpot are a plus"
    ],
    perks: [
      "Opportunity to lead and shape the company’s digital presence",
      "Work with a creative and data-driven marketing team",
      "Real budget ownership and freedom to experiment with new strategies",
      "Long-term career growth in Marketing and Brand Management",
      "Teams that value clean work, accountability and innovation"
    ]
  }
];
