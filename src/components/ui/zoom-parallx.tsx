...
export function ZoomParallax({ images }: ZoomParallaxProps) {
	...
	return (
		<div ref={container} className="relative h-[300vh]">
			<div className="sticky top-0 h-screen overflow-hidden bg-[#F5F5F7]">
				{images.map(({ src, alt }, index) => {
					...
					return (
						<motion.div
                            ...
                            `}
						>
							<div className="relative h-[25vh] w-[25vw] overflow-hidden rounded-xl shadow-2xl border border-white/20">
								<Image
